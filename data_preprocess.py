...
class Preprocesser():
    ...
    def read_and_write_DB(self):
        ...
        self.write_to_fileDB(self.out_path, dict_relations, threshold=self.threshold)

    # helper method
    def write_to_fileDB(self, output_path, dict_relation, threshold):
        """
...
def main():
    """
    path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/DErivBase-v2.0-rulePaths.txt'
    out_path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/deriv_thresh80.csv'
    ...
    path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/deriv_thresh80.csv'
    out_path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/relation_files'
    make_relation_files(path,out_path)
    """
    #data_path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/relation_files'
    #out_path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/split_relations'
    #make_splits_in_dir(data_path, out_path, size_train = 0.6, size_test = 0.2)


    #####UNIMORPH
    # path,out_path, embedding_voc, star=True, OOV =True, threshold=80
    #path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/INFLECTION/deu_formatted.csv'
    #out_path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/INFLECTION/inf_formatted80.csv'
    #embeddings = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/embeddings/word2vec-mincount-30-dims-100-ctx-10-ns-5.w2v'
    #voc = FeatureExtractor(embeddings, 200)
    #prep = Preprocesser(path, out_path, voc.vocab, star=True, OOV=True, threshold=80)
    #prep.read_and_write_unimorph()
    #path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/INFLECTION/inf_formatted80.csv'
    #out_path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/INFLECTION/relations'
    #make_relation_files(path,out_path)



    data_path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/INFLECTION/relations'
    out_path = '/home/evahu/Documents/Master/Master_Dissertation/InflDerivMorph/data2/out/INFLECTION/split_relations'
    make_splits_in_dir(data_path, out_path, size_train = 0.6, size_test = 0.2)

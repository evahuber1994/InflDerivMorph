#!/bin/bash
for i in {4..10}; do
	name="results/german_small_$i"
	mkdir $name 
	mkdir $name/model
	echo $name 
	Config_File="$name/toml_DE_mr.toml"

	echo train_path = \"/home/eva/master_diss/FINAL/DE/small_o1o/combined_train.csv\" >> $Config_File
	echo val_path =  \"/home/eva/master_diss/FINAL/DE/small_o1o/combined_val.csv\" >> $Config_File
	echo test_path = \"/home/eva/master_diss/FINAL/DE/small_o1o/combined_test.csv\" >> $Config_File
	echo out_path = \"$name/\" >> $Config_File
	echo model_path = \"$name/model/model\" >> $Config_File
	echo save_detailed = \"True\" >> $Config_File
	echo embeddings = \"/home/eva/master_diss/de_conll_data/model.fifu\" >> $Config_File
